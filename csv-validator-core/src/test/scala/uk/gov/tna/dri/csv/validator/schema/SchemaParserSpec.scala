...
class SchemaParserSpec extends Specification {
  ...
  "Schema" should {
    ...
    "succeed for valid minimal uk.gov.tna.dri.csv.validator.schema" in {
    ...
    "fail if the uk.gov.tna.dri.csv.validator.schema version is wrong" in {
  ...
  "When there is a named column for a rule the uk.gov.tna.dri.csv.validator.schema" should {
