...
class MetaDataValidatorSpec extends Specification {
  ...
  "Validation" should {
    ...
    "succeed with valid file path" in {
      ...
      val metaData = "src/test/resources/uk/gov/tna/dri/uk.gov.tna.dri.csv.validator.schema/mustExistForRule.txt"
    ...
    "succeed with valid file path where fileExists rule prepends root path to the filename" in {
      ...
      val metaData = "tna/dri/uk.gov.tna.dri.csv.validator.schema/mustExistForRule.txt"
