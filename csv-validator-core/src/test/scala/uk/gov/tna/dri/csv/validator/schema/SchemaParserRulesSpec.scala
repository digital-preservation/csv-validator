...
import uk.gov.tna.dri.csv.validator.SchemaMessage
...
//      val uk.gov.tna.dri.csv.validator.schema = """version 1.0
//                      @totalColumns 1
//                      Name: fileExists()"""
//
//      parse(new StringReader(uk.gov.tna.dri.csv.validator.schema)) must beLike { case Failure("fileExists rule has an invalid file path", _) => ok }
//    }
